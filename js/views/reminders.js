...
import { state, addReminder, updateReminder, deleteReminder, canDelete } from '../store.js';
                        ...
                        ` : filteredReminders.map(reminder => {
                            ...
                            return `
                                <div class="reminder-list-item ${reminder.is_completed ? 'completed' : ''}" data-id="${reminder.id}">
                                    ...
                                    ${canDelete() ? `<button class="reminder-action-btn delete-btn" title="Anımsatıcıyı Sil">
